...
def add_file(project, target, file_path)
  ...
  group_names.each do |name|
    ...
    if found_group.nil?
      found_group = current_group.new_group(name, name)
    end
...
add_file(project, target, 'Features/Energy/EnergyCalculator.swift')
add_file(project, target, 'Features/Energy/EnergyResult.swift')
add_file(project, target, 'Features/Energy/EnergyDetailView.swift')
add_file(project, target, 'Features/Dashboard/EnergyCard.swift')
